...
export class MigrationName1697496102367 implements MigrationInterface {
    name = 'MigrationName1697496102367'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "image" character varying NOT NULL DEFAULT 'https://www.prontaprafesta.com/wp-content/uploads/2018/04/vestido-estilo-princesa-ombro.jpg', "description" character varying NOT NULL, "modelo" character varying NOT NULL, "color" character varying NOT NULL, "code" numeric NOT NULL, "price" numeric NOT NULL, "totalValue" numeric NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "popularity" numeric NOT NULL DEFAULT '0', CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contract" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number" integer NOT NULL, "retirada" TIMESTAMP NOT NULL, "devolucao" TIMESTAMP, "observacao" character varying NOT NULL, "tipo" character varying NOT NULL, "status" character varying NOT NULL, "extra" numeric NOT NULL DEFAULT '0', "total" numeric NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "fechado" TIMESTAMP NOT NULL, "pagamento" numeric NOT NULL, "clientId" uuid NOT NULL, CONSTRAINT "PK_17c3a89f58a2997276084e706e8" PRIMARY KEY ("id"))`);
